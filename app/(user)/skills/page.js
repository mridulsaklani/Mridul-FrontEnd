      ...
      <div className="max-w-7xl m-auto py-20 flex items-center flex-col lg:flex-row pl-5 pr-5">
        <div className="lg:w-1/2">
          <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight text-neutral-200 mb-6 tracking-wide text-center lg:text-start">
            Passionate about{" "}
            <span className="text-blue-500">Continuous Growth.</span>
          </h1>
          <p className="text-xl text-neutral-200 mb-10 text-center lg:text-start">
            I am committed to constant learning and evolving as a software
            engineer, embracing new challenges and technologies to deliver
...
export const metadata = {
  ...
  description:
    "Explore the technical skills of Mridul Singh Saklani, a web developer with expertise in modern frameworks, programming languages, and tools. Discover a strong foundation in creating innovative web solutions.",
};
