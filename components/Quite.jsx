...
const Quite = () => {
  return (
    <>
      <div className="max-w-7xl m-auto my-20 pr-5 pl-5">
        ...
        <div className="flex items-center flex-col lg:flex-row gap-8 mb-12 overflow-hidden md:overflow-auto">
            ...
            <p className="text-lg text-neutral-200 mb-5 text-center lg:text-start">I’m naturally introverted and prefer spending time by myself. Social settings aren’t usually my comfort zone, but with the few people close to my heart, I open up and can talk endlessly. In my free time, I dive into learning new things—a habit that has been with me since childhood.</p>
            <p className="text-lg text-neutral-200 mb-5 text-center lg:text-start">I’ve always been captivated by the mysteries of space—something that never fails to excite me. Physics and mathematics are my favorite subjects, and Niels Bohr’s groundbreaking quantum theories have deeply influenced me. I could discuss quantum physics endlessly with anyone knowledgeable on the subject; for me, nothing compares to the intrigue of quantum mechanics.</p></div>
        ...
        <div className="mb-16">
                ...
                <p className="text-lg text-neutral-200 mb-5 text-center lg:text-start">
